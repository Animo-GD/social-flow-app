...
export const translations = {
  en: {
    ...
    btn_generate_both: 'Generate Full Post',
    ...
    login_unverified: 'Please verify your email first.',
  ...
  ar: {
    ...
    btn_generate_both: 'توليد منشور كامل',
    ...
    login_unverified: 'الرجاء التحقق من بريدك الإلكتروني أولاً.',
